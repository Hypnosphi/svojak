...
this.onmessage = function(e) {
  try {
    if (e.data.cmd === 'load') { // Preload command that is called once per worker to parse and load the Emscripten code.
      ...
      Module = OGVDecoderVideoVP9MTW(Module);
      ...
      Module['STACK_BASE'] = STACK_BASE = Module['STACKTOP'] = STACKTOP = e.data.stackBase;
      Module['STACK_MAX'] = STACK_MAX = STACK_BASE + e.data.stackSize;
